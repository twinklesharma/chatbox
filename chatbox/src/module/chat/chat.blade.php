        ...
        <div class="container">
            <div class="navbar-header">
                ...
                <a href="https://quickblox.com/developers/Chat">
                    <img src="{{asset('laravelchat/images/logo-quickblox.png')}}" id="logo">
                </a>
            </div>
          ...
          <div class="panel-body">
            <div class="row">
              ...
              <div id="mcs_container" class="col-md-8">
                ...
                <div><img src="{{asset('laravelchat/images/ajax-loader.gif')}}" class="load-msg"></div>
                <form class="form-inline" role="form" method="POST" action="" onsubmit="return submit_handler(this)">
                  ...
                  <img src="{{asset('laravelchat/images/ajax-loader.gif')}}" id="progress">
                </form>
              </div>
              </div>
            </div>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <button type="button" value="Quick" id="user1" class="btn btn-primary btn-lg btn-block">Sign in with Twinkle</button>
            <button type="button" value="Blox" id="user2" class="btn btn-success btn-lg btn-block">Sign in with Akansha</button>
<button type="button" value="Blox" id="user3" class="btn btn-success btn-lg btn-block">Sign in with Preeti</button>
            <div class="progress">
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="img-place"><img src="{{asset('laravelchat/images/ajax-loader.gif')}}" id="load-users"></div>
    ...
    <script src="{{asset('laravelchat/js/quickblox.min.js')}}"></script>
    <script src="{{asset('libs/stickerpipe/js/stickerpipe.js')}}"></script>
    <script src="{{asset('laravelchat/js/config.js')}}"></script>
    <script src="{{asset('laravelchat/js/connection.js')}}"></script>
    <script src="{{asset('laravelchat/js/messages.js')}}"></script>
    <script src="{{asset('laravelchat/js/stickerpipe.js')}}"></script>
    <script src="{{asset('laravelchat/js/ui_helpers.js')}}"></script>
    <script src="{{asset('laravelchat/js/dialogs.js')}}"></script>
    <script src="{{asset('laravelchat/js/users.js')}}"></script>
</body>
</html>
